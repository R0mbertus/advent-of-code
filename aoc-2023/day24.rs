...
#[aoc(day24, part1)]
fn part1(input: &Vec<Hailstone>) -> usize {
    ...
    for (stone1, stone2) in input.iter().tuple_combinations() {
        ...
        if t_stone1 < 0 || t_stone2 < 0 || xy_min > intersect_x || xy_max < intersect_x || xy_min > intersect_y || xy_max < intersect_y {
            continue;
        }
...
#[aoc(day24, part2)]
fn part2(input: &Vec<Hailstone>) -> usize {
    todo!()
}
